    ...
    return BlocConsumer<DetailBloc, DetailState>(
      ...
      builder: (context, state) {
         ...
         if (state is DetailLoadedState) {
           print(state.product.image
               .toString() + ' This is the product image');
           return  Scaffold(
             backgroundColor: AppColors.whiteColor,
                 ...
                 children: [
                   Container(
                     ...
                     child: Padding(
                       ...
                       child: Text(state.product.price.toString() + ' ' + ' AED',
                                           ...
                                           Container(
                                               ...
                                               child: Padding(
                                                 ...
                                                 child: Text(
                                                   ...
                                                   style: TextStyle(
                                                       color: AppColors.greyColor, fontSize: TextStylesData.extraSmallFontSize),
                                                 ),
                                               )),
                                           Container(
                                             child: Row(
                                                 ...
                                                 Padding(padding: const EdgeInsets.only(left: 5,right: 5,top: 4),
                                                   child: Container(
                                                       ...
                                                       child: Text(
                                                           ...
                                                           style: TextStyle(
                                                               color: AppColors.blackColor, fontSize: TextStylesData.titleFontSize))),
                                                 ),
                                               ],
                                             ),
                                           ),
