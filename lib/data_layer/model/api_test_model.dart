...
//
//     final getApiTestModel = getApiTestModelFromJson(jsonString);

import 'dart:convert';

GetApiTestModel getApiTestModelFromJson(String str) => GetApiTestModel.fromJson(json.decode(str));

String getApiTestModelToJson(GetApiTestModel data) => json.encode(data.toJson());

class GetApiTestModel {
  List<Result>? results;
  Info? info;
  ...
  factory GetApiTestModel.fromJson(Map<String, dynamic> json) => GetApiTestModel(
